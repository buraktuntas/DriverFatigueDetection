package com.odev.projekamera.activity;
...
import com.odev.projekamera.R;
import com.odev.projekamera.activity.ui.FaceOverlayView;
import com.odev.projekamera.adapter.ImagePreviewAdapter;
import com.odev.projekamera.model.FaceResult;
import com.odev.projekamera.utils.CameraErrorCallback;
import com.odev.projekamera.utils.ImageUtils;
import com.odev.projekamera.utils.Util;


public final class YuzAlgilamaActivity extends AppCompatActivity implements SurfaceHolder.Callback, Camera.PreviewCallback {

    private int numberOfCameras;

    public static final String TAG = YuzAlgilamaActivity.class.getSimpleName();
    ...
    public void onCreate(Bundle icicle) {
        ...
        getSupportActionBar().setTitle("Yüzü Algıla");
        ...
        switch (item.getItemId()) {
            ...
            case R.id.switchCam:
                ...
                if (numberOfCameras == 1) {
                    ...
                    builder.setTitle("Kamera Değiş").setMessage("Cihazınızda bir kamera var").setNeutralButton("Kapat", null);
    ...
    private void setDisplayOrientation() {
        ...
        mDisplayRotation = Util.getDisplayRotation(YuzAlgilamaActivity.this);
...
//            Log.i("FaceDetectThread", "running");
    ...
    private void resetData() {
        if (imagePreviewAdapter == null) {
            ...
            imagePreviewAdapter = new ImagePreviewAdapter(YuzAlgilamaActivity.this, facesBitmap, new ImagePreviewAdapter.ViewHolder.OnItemClickListener() {
                @Override
