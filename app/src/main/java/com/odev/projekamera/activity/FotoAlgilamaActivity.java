...
import com.odev.projekamera.activity.ui.FaceView;
...
public class FotoAlgilamaActivity extends AppCompatActivity {

    private static final String TAG = FotoAlgilamaActivity.class.getSimpleName();
    ...
    public void getImage() {
        ...
        try {
            ...
            Toast.makeText(FotoAlgilamaActivity.this, "Your Device can not select image from gallery.", Toast.LENGTH_LONG).show();
            finish();
        }
    }
    ...
    private void resetData() {
        ...
        if (imagePreviewAdapter == null) {
            ...
            imagePreviewAdapter = new ImagePreviewAdapter(FotoAlgilamaActivity.this, facesBitmap, new ImagePreviewAdapter.ViewHolder.OnItemClickListener() {
                @Override
