package com.odev.projekamera.activity.ui;
...
public class FaceOverlayView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mFaces != null && mFaces.length > 0) {
            ...
            for (FaceResult face : mFaces) {
                ...
                if (mid.x != 0.0f && mid.y != 0.0f) {
                    ...
                    canvas.drawText("KİŞİ " + face.getId(), rectF.left, rectF.bottom + mTextPaint.getTextSize(), mTextPaint);
        ...
        canvas.drawText("Algılanan Çerçeve/s: " + df2.format(fps) + " @ " + previewWidth + "x" + previewHeight, mTextPaint.getTextSize(), mTextPaint.getTextSize(), mTextPaint);
    }
